    ...
    <table id="questionsTable" class="table table-striped">
        ...
        <c:forEach var="quiz" items="${quizList}">
            <tr>
                ...
                <td><c:out value="${quiz.duration}" /></td>
                <td><c:out value="${quiz.questionList.size()}" /></td>
                </a>
                <button class="btn btn-sm btn-outline-danger deleteQuestion" data-id="${quiz.id}">Delete</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
